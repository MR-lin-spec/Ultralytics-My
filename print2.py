...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Test RT-DETR model performance.")
    parser.add_argument('--weights', type=str, default='rtdetr-l.pt', help='trained weights path')
